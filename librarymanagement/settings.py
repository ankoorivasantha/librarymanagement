...
EMAIL_PORT = 587  # Use 587 for TLS; use 465 for SSL
EMAIL_USE_TLS = True  # Enable TLS
EMAIL_USE_SSL = False  # Ensure SSL is disabled if TLS is enabled
EMAIL_HOST_USER = 'ankoorivasantha@gmail.com'
EMAIL_HOST_PASSWORD = 'wcezcploddudhbyt'  # Use an App Password if necessary'
